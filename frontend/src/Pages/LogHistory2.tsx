                    ...
                    <Box>
                        <UpsideGray />
                            ...
                            <Box height={'800px'} display={"flex"} flexDirection={"column"}>
                                ...
                                <Box sx={{width:"302px", height:"40px", alignText:'center', bgcolor:"white", alignContent:'center'}}><Typography sx={{fontWeight:"bold", mt:'8px', ml:'15px'}}>Tino Project</Typography></Box>
